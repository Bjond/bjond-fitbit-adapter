...
public class TestAdapter {
    public static final String ROOT_WAR_DEPLOYMENT_LOCATION = "./build/libs/bjond-slack-adapter.war";
    ...
    public static WebArchive createDeployment() {
        val a = ShrinkWrap.create(ZipImporter.class, "bjond-slack-adapter.war").importFrom(new File(ROOT_WAR_DEPLOYMENT_LOCATION)).as(WebArchive.class);
        log.info("Bjond Slack Adapter War: " + a.toString(true));
        return a;
    }
